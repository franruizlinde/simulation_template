...
export function pointData = stkDB_alter(pointData)
{
    ...
    if (!strcmp(pointName, "400100") || !strcmp(pointName, "400200") || !strcmp(pointName, "400300") || !strcmp(pointName, "400400") || !strcmp(pointName, "400500") || !strcmp(pointName, "400600"))
    {
        pointData->heightOffSet = 0.05;
    }
}
