...
export function comboxId = COMBOX_CONVEYOR() {comboxId = 0;}
export function comboxId = COMBOX_DOCKING() {comboxId = 1;}
...
export function v = doorDB_populate()
{
    ...
    v.{end+1} = varspc(
             'zoneName',        strn('door1'),
             'comboxIDIn',      COMBOX_DOCKING(),
             'comboxPortIn',    1,
             'comboxIDOut',     COMBOX_DOCKING(),
             'comboxPortOut',   3,
             'z',               cpx(67.12,13.7),
             'dim',             cpx(2,0.4),
             'dAsk',            6,
    ...
    v.{end+1} = varspc(
        ...
        //'forceExtension',			1,
         'comboxIDIn',				COMBOX_DOCKING(), // Set at the same value as idFlexi
         'comboxPortIn',			1, // Not used with docking station
         'comboxIDOut',				COMBOX_DOCKING(), // Set at the same value as idFlexi
